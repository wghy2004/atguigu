...
<body>
	...
	<div class="warp container">
		<form action="${base}/sys/category/group">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<span>分组类型列表</span>
					<ul class="option-group">
						<li><a data-toggle="modal" data-backdrop="static" data-target="#myModal" href="${base}/sys/category/group/add" class="glyphicon glyphicon-plus" title="添加"></a></li>
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td>
							<ul class="option-group">
								<li><a data-toggle="modal" data-backdrop="static" data-target="#myModal" href="${base}/sys/category/group/edit/${result.id}" title="编辑"
									class="glyphicon glyphicon-edit"></a></li>
								<li><a href="${base}/sys/category/group/${result.id}" ssr-delete-one title="删除" class="glyphicon glyphicon-trash"></a>
								</li>
							</ul>
						</td>
					</tr>
